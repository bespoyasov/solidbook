...
**Что могло бы помочь решить предыдущую проблему?**

_Поле-словарь внутри класса с возможными форматами и описанными для них фабриками_

_Новый класс для выбора подходящей фабрики из списка существующих_

_Любое динамическое определение класса-фабрики_
