...
class HrAgency implements PositionObservable {
  ...
  subscribe = (event: string, applicant: ApplicantObserver): void => {
    this.listeners[event] = this.listeners[event] || []
    this.listeners[event].push(applicant)
  }

  unsubscribe = (event: string, applicant: ApplicantObserver): void => {
