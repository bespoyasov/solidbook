...
Вернёмся к примеру. Сейчас классы фигур подчиняются новому ограничению и имплементируют интерфейс `AreaCalculatable`:
...
class AreaCalculator {
  ...
  //    при условии, что они имплементируют AreaCalculatable
