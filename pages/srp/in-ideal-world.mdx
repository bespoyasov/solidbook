...
Для решения задачи выбора формата мы спользуем шаблон проектирования [Стратегия](https://refactoring.guru/ru/design-patterns/strategy), [розбор которого будет в будущей теме](/ocp/patterns).
