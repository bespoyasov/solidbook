...
Также адаптер [помогает справляться](https://bespoyasov.ru/blog/adapter-pattern/) со «сломанным» API от бэкенда и преобразованием одних структур данных в другие.
