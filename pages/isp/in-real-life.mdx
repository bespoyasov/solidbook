...
ISP можно рассматривать, как [SRP](/srp) для интерфейсов. Его главная задача — помочь спроектировать интерфейсы так, чтобы в них не было ничего лишнего. Принцип помогает выявлять более высокие абстракции и находить неочевидные связи между сущностями.
