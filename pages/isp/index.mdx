...
[Проблема банана и джунглей](https://dzone.com/articles/lamenting-the-death-of-object-oriented-programming) — одна из тех, за которые [не любят](https://medium.com/@cscalfani/goodbye-object-oriented-programming-a59cda4c0e53) ООП. Простыми словами её суть — когда при наследовании класс-потомок получает вместе с нужной функциональностью кучу неиспользуемой и ненужной.
