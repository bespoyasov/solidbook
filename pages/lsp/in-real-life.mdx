...
Ещё один пример LSP — это React-компоненты, а точнее их реализация в JSX. [Синтаксис JSX](https://ru.reactjs.org/docs/introducing-jsx.html) построен таким образом, что мы можем писать разметку компонентов в HTML-подобном виде:
