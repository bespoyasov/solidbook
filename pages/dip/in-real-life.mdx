...
Для большего контроля над зависимостями и урпощения тестирования DIP предлагает использовать [инверсию контроля](https://en.wikipedia.org/wiki/Inversion_of_control) (Inversion of Control, IoC) и [инъекцию зависмостей](https://en.wikipedia.org/wiki/Dependency_injection) (Dependency Injection, DI).
