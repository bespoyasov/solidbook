...
Для большего контроля над зависимостями и урпощения тестирования DIP предлагает использовать инверсию контроля (Inversion of Control, IoC) и [инъекцию зависмостей](https://en.wikipedia.org/wiki/Dependency_injection) (Dependency Injection, DI).
...
При тестировании удобно использовать DI, чтобы заменять зависимости на фейковые объекты.
