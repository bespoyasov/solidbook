...
export const srpPatterns1: IQuiz = {
  name: 'srp-patterns-1',
  ...
  variants: [
    ...
    },
    {
      ...
      description:
        'Этот приём — уже инструмент исправления подобной ошибки, определить неоправданно большое количество назначений необходимо до применения «Выделения класса»'
    },
    {
